...
export default function Card({
  ...
  return (
    <div className="bg-[#664F4F]/50 backdrop-blur-sm rounded-lg p-3 md:p-4 border border-black/30 w-full h-full">
      <div>
      ...
      <div className="pt-4 md:pt-6 pb-6 md:pb-10">
        <p className="text-justify text-sm md:text-base">{descricaoCard}</p>
      </div>
    </div>
  );
}
